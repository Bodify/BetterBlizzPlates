...
function BBP.UpdateImportantBuffsAndCCTables()
    ...
    if BBP.isTBC then
        ...
        ccSilence[30108]   = true    -- Unstable Affliction (Silence)
        ccSilence[30404]   = true    -- Unstable Affliction (Silence)
        ccSilence[30405]   = true    -- Unstable Affliction (Silence)
        ...
        ogKeyAuraList[114028]  = "importantColor"     -- Mass Spell Reflection
        ogKeyAuraList[23920]   = "importantColor"     -- Spell Reflection
        ogKeyAuraList[46924]   = "offensiveColor"       -- Bladestorm
        ogKeyAuraList[19263]   = "defensiveColor"       -- Deterrence
        ogKeyAuraList[47585]   = "defensiveColor"       -- Dispersion
        ...
        ogKeyAuraList[92681]   = true       -- Phase Shift
        ...
        ogKeyAuraList[111397]  = true     -- Blood Horror (flee on attack)
        ogKeyAuraList[45182]   = "defensiveColor"     -- Cheating Death (85% reduced inc dmg)
        ogKeyAuraList[31821]   = "importantColor"     -- Aura Mastery
        ogKeyAuraList[53480]   = "defensiveColor"     -- Roar of Sacrifice
        ogKeyAuraList[147833]  = "importantColor"     -- Intervene
        ogKeyAuraList[114029]  = "importantColor"     -- Safeguard
        ogKeyAuraList[3411]    = "importantColor"     -- Intervene
        ogKeyAuraList[53476]   = "importantColor"     -- Intervene (Hunter Pet)
        ...
        ogKeyAuraList[76577]   = true      -- Smoke Bomb
        ogKeyAuraList[88611]   = true      -- Smoke Bomb
        ogKeyAuraList[6346]    = "importantColor"      -- Fear Ward
        ogKeyAuraList[7744]    = true      -- Will of the Forsaken


        importantOffensives[46924]   = true       -- Bladestorm
        ...
        importantOffensives[50334]   = true       -- Berserk
        ...
        importantOffensives[131078]  = true       -- Icy Veins (split)
        importantOffensives[32182]   = true       -- Heroism
        importantOffensives[51690]   = true       -- Killing Spree
        importantOffensives[17941]   = true       -- Shadow Trance
        ...
        importantOffensives[51713]   = true       -- Shadow Dance
        importantOffensives[107574]  = true       -- Avatar
        importantOffensives[121471]  = true       -- Shadow Blades
        importantOffensives[105809]  = true       -- Holy Avenger
        importantOffensives[86698]   = true       -- Guardian of Ancient Kings (alt)
        importantOffensives[113858]  = true       -- Dark Soul: Instability
        importantOffensives[113860]  = true       -- Dark Soul: Misery
        importantOffensives[113861]  = true       -- Dark Soul: Knowledge
        importantOffensives[114050]  = true       -- Ascendance (Enhancement)
        importantOffensives[114051]  = true       -- Ascendance (Elemental)
        importantOffensives[102543]  = true       -- Incarnation: King of the Jungle
        importantOffensives[102560]  = true       -- Incarnation: Chosen of Elune
        importantOffensives[106951]  = true       -- Berserk
        importantOffensives[124974]  = true       -- Nature’s Vigil
        importantOffensives[51271]   = true       -- Pillar of Frost
        importantOffensives[49206]   = true       -- Summon Gargoyle
        importantOffensives[114868]  = true       -- Soul Reaper (Buff)
        importantOffensives[137639]  = true       -- Storm, Earth, and Fire
        ...
        importantOffensives[84747]   = true     -- Deep Insight (Red Buff Rogue)
        importantOffensives[1247275] = true     -- Tigereye Brew (Monk)
        ...
        importantDefensives[132158]  = true    -- Natures's Swiftness
        ...
        importantDefensives[118038]  = true    -- Die by the Sword
        importantDefensives[33206]   = true    -- Pain Suppresion
        importantDefensives[44416]   = true    -- Pain Suppression
        importantDefensives[47788]   = true    -- Guardian Spirit
        importantDefensives[89485]   = true    -- Inner Focus (instant cast immunity)
        ...
        importantDefensives[55694]   = true    -- Enraged Regeneration
        importantDefensives[22812]   = true    -- Barkskin
        importantDefensives[47484]   = true    -- Huddle
        importantDefensives[97463]   = true    -- Rallying Cry
        importantDefensives[86669]   = true    -- Guardian of Ancient Kings
        importantDefensives[108359]  = true    -- Dark Regeneration
        importantDefensives[108416]  = true    -- Sacrificial Pact
        importantDefensives[104773]  = true    -- Unending Resolve
        importantDefensives[110913]  = true    -- Dark Bargain
        importantDefensives[79206]   = true    -- Spiritwalker's Grace (movement casting)
        importantDefensives[108271]  = true    -- Astral Shift
        importantDefensives[108281]  = true    -- Ancestral Guidance (healing)
        importantDefensives[31616]   = true    -- Nature’s Guardian
        importantDefensives[114052]  = true    -- Ascendance (Restoration)
        importantDefensives[61336]   = true    -- Survival Instincts
        importantDefensives[106922]  = true    -- Might of Ursoc
        importantDefensives[81782]   = true    -- Power Word: Barrier
        importantDefensives[12976]   = true    -- Last Stand
        importantDefensives[109964]  = true    -- Spirit Shell (Buff)
        importantDefensives[102342]  = true    -- Ironbark
        importantDefensives[29166]   = true    -- Innervate
        importantDefensives[30458]   = true    -- Nigh Invulnerability Shield
        importantDefensives[30457]   = true    -- Nigh Invulnerability Belt Backfire
        importantDefensives[114908]  = true    -- Spirit Shell (Absorb Shield)
        importantDefensives[64901]   = true    -- Hymn of Hope
        importantDefensives[98007]   = true    -- Spirit Link Totem
        importantDefensives[114214]  = true    -- Angelic Bulwark
        importantDefensives[114893]  = true    -- Stone Bulwark Totem
        importantDefensives[117679]  = true    -- Incarnation: Tree of Life
        importantDefensives[19263]   = true       -- Deterrence
        importantDefensives[47585]   = true       -- Dispersion
        ...
        importantDefensives[92681]   = true       -- Phase Shift
        importantDefensives[31224]   = true       -- Cloak of Shadows
        importantDefensives[27827]   = true       -- Spirit of Redemption
        importantDefensives[148467]  = true       -- Deterrence
        importantDefensives[31821]   = true     -- Aura Mastery
        importantDefensives[147833]  = true     -- Intervene
        importantDefensives[114029]  = true     -- Safeguard
        importantDefensives[3411]    = true     -- Intervene
        importantDefensives[53476]   = true     -- Intervene (Hunter Pet)
        importantDefensives[23920]   = true     -- Spell Reflection
        importantDefensives[114028]  = true     -- Mass Spell Reflection
        importantDefensives[5384]    = true     -- Feign Death
        importantDefensives[45182]   = true     -- Cheating Death (85% reduced inc dmg)
        importantDefensives[53480]   = true     -- Roar of Sacrifice
