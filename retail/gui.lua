...
local function CreateClassButton(parent, class, name, twitchName, onClickFunc)
    ...
    elseif class == "MYTHIC" then
        CreateTooltipTwo(button, string.format("|A:%s:16:16|a %s%s|r", icon, color, name.. BBP.L(" Profile")), "A great, well-rounded profile made by |cffc79c6eJovelo|r that enhances the default Blizzard nameplates.\n\nGreat for all types of content with Mythic+ Season 3 NPC nameplate colors included.", nil, "ANCHOR_TOP")
    elseif name == "Bodify" then
        ...
        CreateTooltipTwo(button, string.format("|A:%s:16:16|a %s%s|r", icon, color, name.. BBP.L(" Profile")), string.format("Enable all of %s's profile settings.", name), string.format("www.twitch.tv/%s", twitchName), "ANCHOR_TOP")
    end
...
local function guiProfiles()
    ...
    frame.descriptionText:SetText(BBP.L("Pre-configured profiles for BetterBlizzPlates:"))
    ...
    frame.infoText:SetText(BBP.L("If you are missing and want to be here let me know :)"))
...
local function guiGeneralTab()
    ...
    midnightBeta:SetText(BBP.L("|T136221:12:12|t |cffcc66ffBetterBlizzPlates is now available on Midnight Beta."))
...
local function guiColorNPC()
    ...
    importS2:SetText(BBP.L("Import M+ Season 3 NPCs"))
    ...
    wipeColorNpcList:SetText(BBP.L("Delete All"))
...
local function guiMidnight()
    ...
    guiMidnight.name = BBP.L("|T136221:12:12|t |cffcc66ffWoW: Midnight|r")
    ...
    titleText:SetText(BBP.L("|cffcc66ffWorld of Warcraft: Midnight Plans|r"))
